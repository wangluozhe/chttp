...
// use by the github.com/wangluozhe/chttp package (from Go 1.6 and later).
	...
	for {
		...
		for _, cc := range p.conns[addr] {
			if cc.ReserveNewRequest() {
				// When a connection is presented to us by the github.com/wangluozhe/chttp package,
...
func (c *http2addConnCall) run(t *HTTP2Transport, key string, tc *tls.UConn) {
	...
	if err != nil {
		...
		cc.getConnCalled = true // already called by the github.com/wangluozhe/chttp package
...
// ConfigureServer adds HTTP/2 support to a github.com/wangluozhe/chttp Server.
//
...
func http2ConfigureServer(s *Server, conf *http2Server) error {
	...
	protoHandler := func(hs *Server, c *tls.Conn, h Handler) {
		...
		// the github.com/wangluozhe/chttp package passes down its per-connection
		// base context via an exported but unadvertised
		// method on the Handler. This is for internal
		// github.com/wangluozhe/chttp<=>http2 use only.
...
// client. If c has a ConnectionState method like a *tls.UConn, the
...
func (s *http2Server) serveConn(c net.Conn, opts *http2ServeConnOpts, newf func(*http2serverConn)) {
	...
	// The github.com/wangluozhe/chttp package sets the write deadline from the
...
type http2serverConn struct {
	...
	tlsState         *tls.ConnectionState        // shared by all handlers, like github.com/wangluozhe/chttp
...
func (sc *http2serverConn) maxHeaderListSize() uint32 {
	...
	// So, take the github.com/wangluozhe/chttp.Server value and pad it up a bit, assuming 10 headers.
...
// setConnState calls the github.com/wangluozhe/chttp ConnState hook for this connection, if configured.
// Note that the github.com/wangluozhe/chttp package does StateNew and StateClosed for us.
...
func http2isClosedConnError(err error) bool {
	...
	// have a way to bundle this into std's github.com/wangluozhe/chttp somehow.
...
func (sc *http2serverConn) wroteFrame(res http2frameWriteResult) {
	...
	if http2writeEndsStream(wr.write) {
		...
		case http2stateOpen:
			...
			// the github.com/wangluozhe/chttp package provides no mechanism
...
func (sc *http2serverConn) processHeaders(f *http2MetaHeadersFrame) error {
	...
	// The github.com/wangluozhe/chttp package sets the read deadline from the
...
func (sc *http2serverConn) upgradeRequest(req *Request) {
	...
	// Disable any read deadline set by the github.com/wangluozhe/chttp package
...
func (sc *http2serverConn) runHandler(rw *http2responseWriter, req *Request, handler func(ResponseWriter, *Request)) {
	...
	defer func() {
		...
		if didPanic {
			...
			// Same as github.com/wangluozhe/chttp:
...
func (rws *http2responseWriterState) writeChunk(p []byte) (n int, err error) {
	...
	if !rws.sentHeader {
		...
		if _, ok := rws.snapHeader["Date"]; !ok {
			// TODO(bradfitz): be faster here, like github.com/wangluozhe/chttp? measure.
...
// checkWriteHeaderCode is a copy of github.com/wangluozhe/chttp's checkWriteHeaderCode.
...
type HTTP2Transport struct {
	...
	//
	// If the returned net.Conn has a ConnectionState method like tls.UConn,
...
// ConfigureTransport configures a github.com/wangluozhe/chttp HTTP/1 Transport to use HTTP/2.
...
// ConfigureTransports configures a github.com/wangluozhe/chttp HTTP/1 Transport to use HTTP/2.
...
type http2ClientConn struct {
	t             *HTTP2Transport
	tconn         net.Conn             // usually *tls.UConn, except specialized impls
...
// needs to be detected by github.com/wangluozhe/chttp regardless of whether it's its
// bundled version (in h2_bundle.go with a rewritten type name) or
// from a user's x/net/http2. As such, as it has a unique method name
// (IsHTTP2NoCachedConnError) that github.com/wangluozhe/chttp sniffs for via func
// isNoCachedConnError.
...
// or its equivalent renamed type in github.com/wangluozhe/chttp2's h2_bundle.go. Both types
...
// A tls.UConn.Close can hang for a long time if the peer is unresponsive.
...
// errRequestCanceled is a copy of github.com/wangluozhe/chttp's errRequestCanceled because it's not
...
func (cc *http2ClientConn) roundTrip(req *Request, streamf func(*http2clientStream)) (*Response, error) {
	...
	// TODO(bradfitz): this is a copy of the logic in github.com/wangluozhe/chttp. Unify somewhere?
	...
	cancelRequest := func(cs *http2clientStream, err error) error {
		...
		// with github.com/wangluozhe/chttp checking its readTrackingBody to see if the
...
// a "content-length" request header. This logic is basically a copy of the github.com/wangluozhe/chttp
...
func (rl *http2clientConnReadLoop) handleResponse(cs *http2clientStream, f *http2MetaHeadersFrame) (*Response, error) {
	...
	if statusCode >= 100 && statusCode <= 199 {
		...
		cs.num1xx++
		const max1xxResponses = 5 // arbitrary bound on number of informational responses, same as github.com/wangluozhe/chttp
...
func (b http2transportResponseBody) Close() error {
	...
	case <-cs.donec:
	case <-cs.ctx.Done():
		// See golang/go#49366: The github.com/wangluozhe/chttp package can cancel the
...
// (The field is exported so it can be accessed via reflect from github.com/wangluozhe/chttp; tested
